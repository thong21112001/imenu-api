...
| `npm run test:phase3` | Chạy toàn bộ 12 kịch bản tích hợp E2E Phase 3 (Super Admin, Soft Delete, Staff & RBAC) |
...
| `npm run test:phase3` | Runs all 12 Phase 3 E2E integration tests (Super Admin, Soft Delete, Staff & RBAC) |
